...
const (
	CalculatorService_AddNumbers_FullMethodName = "/proto.CalculatorService/AddNumbers"
)
...
func (c *calculatorServiceClient) AddNumbers(ctx context.Context, in *CalculatorRequest, opts ...grpc.CallOption) (*CalculatorResponse, error) {
	out := new(CalculatorResponse)
	err := c.cc.Invoke(ctx, CalculatorService_AddNumbers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCalculatorServiceServer) AddNumbers(context.Context, *CalculatorRequest) (*CalculatorResponse, error) {
...
func _CalculatorService_AddNumbers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CalculatorService_AddNumbers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).AddNumbers(ctx, req.(*CalculatorRequest))
	}
